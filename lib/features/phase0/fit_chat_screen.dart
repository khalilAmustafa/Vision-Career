...
class _FitChatScreenState extends State<FitChatScreen> {
  ...
  Future<void> _loadQuestions() async {
    try {
      ...
      final questions = await _geminiService.buildGuidedChatQuestions(
      ...
      setState(() {
        ...
        _errorMessage =
            'AI chat questions could not be generated, so a safe multi-college guided flow is being used.';
        _isLoading = false;
      });
    }
  }
  ...
  Future<void> _submitAnswer() async {
    ...
    try {
      ...
      setState(() {
        _errorMessage = 'Could not finalize the AI chat summary. Please try again.';
        _isSubmitting = false;
      });

      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Chat summary failed: $error')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Find Your Fit • Stage 2'),
      ),
      body: Container(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Guided AI Chat • Question ${_currentIndex + 1} of ${_questions.length}',
                          ...
                          const Text(
                            'This stage should help the user discover the right college direction first, then the right specialty inside it.',
                            style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              isUser ? const Color(0xFF1C5D7D) : const Color(0xFF111E34),
          borderRadius: BorderRadius.circular(18),
